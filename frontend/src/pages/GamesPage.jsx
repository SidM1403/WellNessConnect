...
const GamesPage = () => {
    return (
        <div className="min-h-screen pt-32 pb-40 px-4 max-w-7xl mx-auto">
            ...
            >
                <div className="inline-flex items-center justify-center p-3 mb-4 rounded-full bg-surface-100 ring-1 ring-surface-200 shadow-sm">
                    <FaBrain className="text-2xl text-primary-500 mr-2" />
                    <span className="font-semibold text-text-primary">Brain & Wellness</span>
                </div>
                ...
                <div className="mt-4 inline-block bg-amber-50 border border-amber-200 rounded-lg px-4 py-2 text-sm text-amber-800">
                ...
                {games.map((game, index) => (
                    ...
                    >
                        <Link to={game.path} className="block group h-full">
                            <div className="relative overflow-hidden bg-white rounded-3xl p-6 shadow-soft-lg hover:shadow-soft-xl transition-all duration-300 border border-surface-200 h-full flex flex-col group-hover:-translate-y-1">
                                ...
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <span className="px-3 py-1 rounded-full text-xs font-semibold bg-surface-100 text-text-secondary border border-surface-200">
                                        {game.difficulty}
                                    </span>
                                </div>
