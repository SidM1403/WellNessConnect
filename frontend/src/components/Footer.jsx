...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-surface-50 to-white pt-20 pb-10 overflow-hidden border-t border-surface-200/60 rounded-t-[2.5rem] mt-auto">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-3 group w-fit">
              ...
              <span className="font-display font-bold text-xl text-text-primary tracking-tight">WellConnect</span>
            </Link>
            ...
            <div className="pt-2">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface-100 border border-surface-200 text-xs font-semibold text-primary-600">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-text-primary mb-6 text-lg">Quick Links</h3>
            <ul className="space-y-4">
              {footerLinks.quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="text-text-secondary hover:text-primary-600 transition-colors flex items-center gap-2 group"
                  >
          ...
          {/* Resources */}
          <div>
            <h3 className="font-bold text-text-primary mb-6 text-lg">Resources</h3>
            <ul className="space-y-4">
          ...
          {/* Social & Contact */}
          <div>
            <h3 className="font-bold text-text-primary mb-6 text-lg">Connect With Us</h3>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`w-10 h-10 rounded-full bg-white border border-surface-200 flex items-center justify-center text-text-secondary shadow-sm hover:shadow-md transition-all duration-300 ${social.color}`}
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-surface-200/60 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-text-light">
